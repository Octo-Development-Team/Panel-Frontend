    ...
    >
      ...
      <div class="uk-card-body">
        <div class="uk-align-center">
          <button class="uk-button uk-border-rounded" :class="module.enabled ? 'uk-button-primary' : 'uk-button-danger'" @click.prevent="toggleModule(module.keyword)">Toggle</button>
        </div>
      </div>
    </div>
  </div>
